			...
			<div id="cadastro">
				<form method="post" action="../alterar">
					...
					<p>
						...
						<input id="email" name="email" type="email" value="<%= contato.getEmail() %>" />
					</p>
					...
					<p>
						...
						<input id="fone" name="fone" type="text" value="<%= contato.getTelefone() %>" />
					</p>

					<p>
						<label for="data">Data Nascimento</label> 
						<input id="data" name="data" type="date" value=<%= contato.getDataNascimento() %> />
					</p>
